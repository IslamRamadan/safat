...
@section('page_title')  @lang('site.country_region') :
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    ...
                    <a class="btn btn-success mb-2" href="{{route('regions.create')}}">@lang('site.new_region')</a>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('regions.view' , $country->id) }}",
                columns: [
