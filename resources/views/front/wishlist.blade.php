            ...
            <div class="row  dir-rtl col-dir" style="display: flex">
                <div class="col-xs-3 col-3 col-md-2  left-menu row-dir" style="float:right">
                    ...
                    <a href="{{ route('myaccount') }}" class="icon-container">
                        <div class=""><i class="fas fa-user">

                            </i><br><span class="title-span">@lang('site.myaccount')</span></div>
                    </a>
                    <a href="{{ route('wishlist.view') }}" class="icon-container">
                        <div class="bg-b"><i class=" far fa-heart"></i><br>
                            <span class="title-span">@lang('site.mywishlist') </span>
                        </div>
                    </a>
                    <a href="{{ route('myorder') }}" class="icon-container">
                        <div class=""><i class="fas fa-clock"></i><br><span
                                class="title-span">@lang('site.my_order') </span></div>
                    </a>
                    <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                         document.getElementById('logout-form').submit();"
                        class="icon-container">
                        <div><i class="fas fa-lock"></i><br><span class="title-span">@lang('site.logout')</span>
                        </div>
                    </a>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('product', $wih->id) }}">
                                                    <img alt=" T-shirts" src="{{ asset('/storage/' . $wih->img) }}"
                                                        width="100px;">
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="subtotal text-center" data-title="SUBTOTAL">
                                                <a href="#" class="removeFromWishList text-danger"
                                                    data-product-id="{{ $wih->id }}">
                    ...
                    @if ($products->count() > 0)
                        @foreach ($products as $wih)
                            <div class="row border  text-center"><br>
                                ...
                                <a href="{{ route('product', $wih->id) }}"
                                    class="active col-12">{{ $wih->title_ar }}</a>
                                <br>


                                <p class="col-12">price: {{ Auth::user()->getPrice($wih->price) }}
                                    @lang('site.kwd')</p>

                                <p class="col-12 text-left">
                                    <a href="#" class="removeFromWishList text-danger d-flex justify-content-center"
                                        data-product-id="{{ $wih->id }}">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                </p>
