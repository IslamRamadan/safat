...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2022 at 05:42 PM
...
CREATE TABLE `orders` (
  ...
  `national_id` longtext COLLATE utf8mb4_unicode_ci,
  `note` longtext COLLATE utf8mb4_unicode_ci,
  `invoice_id` longtext COLLATE utf8mb4_unicode_ci,
  `invoice_link` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `pages` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `page_title_ar` longtext COLLATE utf8mb4_unicode_ci,
  `page_details_ar` longtext COLLATE utf8mb4_unicode_ci,
  `page_title_en` longtext COLLATE utf8mb4_unicode_ci,
  `page_details_en` longtext COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `posts` (
  ...
  `description_en1` text COLLATE utf8mb4_unicode_ci,
...
(103, 'embroidered abaya', 'عباية مطرزة', 'Abaya in its spirit at a price of 68 dinars\r\nAbaya with pants for 78 dinars', 'العباية بروحها بسعر 68 دينار\r\nالعباية مع البنطلون بسعر 78 دينار', 1, 0, 1, 78, NULL, 'uploads/products/images/9.jpg', 1, 1, 3, 4, 1, 1, 1, 1, 1, 1, '2022-01-01 11:28:24', '2022-01-01 11:28:24'),
(123, 'Khomar', 'خمار مع قبعه', 'خمار مع قبعه داخليه من غير نقاب', 'خمار مع قبعه داخليه من غير نقاب', 1, 0, 1, 15, NULL, 'uploads/products/images/15.jpg', 1, 4, 19, 4, 1, 0, 1, 1, 1, 1, '2022-01-07 13:26:22', '2022-01-09 12:45:24'),
(125, 'خمار مع قبعه داخليه من غير نقاب', 'خمار مع قبعه داخليه من غير نقاب', 'خمار مع قبعه داخليه من غير نقاب', 'خمار مع قبعه داخليه من غير نقاب', 1, 0, 1, 15, NULL, 'uploads/products/images/14.jpg', 1, 4, 19, 4, 1, 0, 1, 1, 1, 1, '2022-01-08 14:38:32', '2022-01-08 14:38:32');
...
CREATE TABLE `settings` (
  ...
  `site_des_en` longtext COLLATE utf8mb4_unicode_ci,
  `email` longtext COLLATE utf8mb4_unicode_ci,
...
(2, '.', '.', '.', '.', 'uploads/sliders/images/16436764286274.jpg', '2021-09-13 21:59:25', '2022-01-31 22:47:08'),
...
(1, 'saramerdas', 'safat@gmail.com', NULL, '$2y$10$/LesaFk5MWKpNZF/1dOMteNz65.ItLRkqWttGgv/.nJienzke40vO', 'safat2022', '96700033', 1, 1, NULL, '2021-09-11 21:13:55', '2022-02-02 14:12:09'),
